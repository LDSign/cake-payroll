...
{
    public $year = 2017;
    public $external = 'https://www.bmf-steuerrechner.de/interface/LSt2017.jsp';
    ...
    public $JFREIB; // Jahresfreibetrag für die Ermittlung der Lohnsteuer für die sonstigen Bezüge nach Maßgabe der elektronischen Lohnsteuerabzugsmerkmale nach § 39e EStG oder der Eintragung auf der Bescheinigung für den Lohnsteuerabzug 2017 in Cent (ggf. 0)
    public $JHINZU; // Jahreshinzurechnungsbetrag für die Ermittlung der Lohnsteuer für die sonstigen Bezüge nach Maßgabe der elektronischen Lohnsteuerabzugsmerkmale nach § 39e EStG oder der Eintragung auf der Bescheinigung für den Lohnsteuerabzug 2017 in Cent (ggf. 0)
    ...
    public $LZZFREIB; // Der als elektronisches Lohnsteuerabzugsmerkmal für den Arbeitgeber nach § 39e EStG festgestellte oder in der Bescheinigung für den Lohnsteuerabzug 2017 eingetragene Freibetrag für den Lohnzahlungszeitraum in Cent
    public $LZZHINZU; // Der als elektronisches Lohnsteuerabzugsmerkmal für den Arbeitgeber nach § 39e EStG festgestellte oder in der Bescheinigung für den Lohnsteuerabzug 2017 eingetragene Hinzurechnungsbetrag für den Lohnzahlungszeitraum in Cent
    ...
    public $R; // Religionsgemeinschaft des Arbeitnehmers lt. elektronischer Lohnsteuerabzugsmerkmale oder der Bescheinigung für den Lohnsteuerabzug 2017 (bei keiner Religionszugehörigkeit = 0)
    public $RE4; // Steuerpflichtiger Arbeitslohn vor Berücksichtigung des Versorgungsfreibetrags und des Zuschlags zum Versorgungsfreibetrag, des Altersentlastungsbetrags und des als elektronisches Lohnsteuerabzugsmerkmal festgestellten oder in der Bescheinigung für den Lohnsteuerabzug 2017 für den Lohnzahlungszeitraum eingetragenen Freibetrags bzw. Hinzurechnungsbetrags in Cent
    ...
    private function MPARA()
    {
        ...
        if ($this->PVS == 1) {
            $this->PVSATZAN = 0.01775;
            $this->PVSATZAG = 0.00775;
        } else {
            $this->PVSATZAN = 0.01275;
            $this->PVSATZAG = 0.01275;
        }
    ...
    private function UPTAB17()
    {
        if ($this->X < $this->GFB + 1) {
            ...
            if ($this->X < 13770) {
                ...
                $this->RW = $this->Y * 1007.27;
                $this->RW = $this->RW + 1400;
                $this->ST = floor($this->RW * $this->Y);
            } elseif ($this->X < 54058) {
                $this->Y = ($this->X - 13769) / 10000;
                $this->RW = $this->Y * 223.76;
                $this->RW = $this->RW + 2397;
                $this->RW = $this->RW * $this->Y;
                $this->ST = floor($this->RW + 939.57);
            } elseif ($this->X < 256304) {
                $this->ST = floor($this->X * 0.42 - 8475.44);
            } else {
                $this->ST = floor($this->X * 0.45 - 16164.53);
            }
        }
